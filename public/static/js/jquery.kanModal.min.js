...
;(function(factory) {
    ...
    load: function(remote) {
      ...
      $.ajax({
        ...
        beforeSend: function( xhr ) {
          xhr.setRequestHeader('X-Requested-With', {toString: function(){ return 'modal-html'; }});
          var html_loading = '\
          <p style="text-align:center; font-size:16px; padding:60px 0; color:#b7c5ce; line-height:36px;">\
            <img src="/static/images/loading.gif" width="36"/>\
            <br/>\
            Loading...\
          </p>\
          ';
          self.$modal.find('.modal-body').html(html_loading);
        },
        ...
        error: function(error){
          self.$modal.find('.modal-body').html('Load Failed');
        }
      });
    },
    reload: function() {
  ...
  $.fn[pluginName].defaultBtns = function() {
    ...
    defaultBtn.submit = {
      ...
      attrString: 'data-loading-text="Submiting.."',
