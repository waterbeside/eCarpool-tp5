...
class Nim extends AdminBase
{
    ...
    public function create_imid($uid, $isUpdate = 1)
    {
        ...
        $icon       = $user->imgpath ?
            config('secret.avatarBasePath') . $user->imgpath : config('secret.avatarBasePath') . "im/default.png";
    ...
    public function im_user($uid)
    {
        ...
        if ($user->im_id && $user->im_md5password) {
            ...
            if ($res['code'] == 200) {
                ...
                $isCreateSuccess = 1;
                // $user->save();
            } elseif ($res['code'] == 414 && $res['desc'] == "already register") {
