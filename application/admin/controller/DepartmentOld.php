...
class DepartmentOld extends AdminBase
{
    ...
    public function index($keyword = '', $page = 1)
    {
        ...
        $fields = 'd.departmentid,d.department_name,d.is_active,d.sub_company_id,d.company_id,
                cs.sub_company_name,cs.city_name,
                c.company_name,c.short_name as company_short_name';
        $join = [
        ...
        $lists = $this->department_model->alias('d')->join($join)
