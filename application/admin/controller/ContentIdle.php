...
class ContentIdle extends AdminBase
{
    ...
    public function index($filter = null, $pagesize = 24)
    {
        ...
        $fields = "t.id,t.user_id,t.title,t.desc,t.images,t.location,t.price,t.status,
            t.is_seller,t.post_time,t.is_delete,t.original_price,t.show_level,
            u.name,u.phone,u.loginname";
        $map = [
            // ["t.is_delete","<>",1],
        ...
        $results = IdleModel::alias('t')->field($fields)->json(['images'])
                    ->where($map)->join($join)->order($orderby)
    ...
    {
        $fields = "t.id,t.user_id,t.title,t.desc,t.images,t.location,t.price,t.status,
                t.is_seller,t.post_time,t.is_delete,t.original_price,
                u.name,u.phone,u.loginname";
        $map = [
            ["t.id", "=", $id],
        ];
