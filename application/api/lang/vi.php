...
return [
    ...
    'This user is already on the passenger list for your current trip' => 'Người dùng này đã có trong danh sách hành khách cho chuyến đi hiện tại của bạn.',
    'Trip has ended and cannot be operated' => 'Chuyến đi đã kết thúc và không thể được vận hành.',
    'You are already a passenger on this trip' => 'Bạn đã là một hành khách trong chuyến đi này.',
    ...
    'You have already taken this trip' => 'Bạn đã có trong chuyến đi này.',
    'You have been picked up by another trip' => 'Bạn đã được chọn bởi một người lái xe khác.',
