...
return [
    ...
    'This user is already on the passenger list for your current trip' => '该用户已在你当前行程的乘客列表中',
    'Trip has ended and cannot be operated' => '行程已结束，无法操作',
    'You are already a passenger on this trip' => '你已经是这趟行程的乘客',
    ...
    'You have already taken this trip' => '你已经搭上过这趟行程',
    'You have been picked up by another trip' => '你已经被其它司机搭了',
