...
class Reports extends ApiBase
{
  ...
  public function today_info()
  {
    ...
    $sql = "SELECT i.infoid, i.carownid, i.passengerid, c.name as d_name, c.Department as d_department,c.carnumber, p.name as p_name, p.Department as p_department, i.time
        FROM info as i
